...
public enum ReturnCode {
     ...
     */
    用户端错误("A0001", "用户端错误"),
    用户注册错误("A0100", "用户注册错误"), // 去除历史尾部空格，保证实际返回文案与错误码文档一致。
    ...
    用户登录异常("A0200", "用户登录异常"), // 去除历史尾部空格，保证实际返回文案与错误码文档一致。
    ...
    访问权限异常("A0300", "访问权限异常"), // 去除历史尾部空格，保证实际返回文案与错误码文档一致。
    访问未授权("A0301", "访问未授权"),
    正在授权中("A0302", "正在授权中"),
    用户授权申请被拒绝("A0303", "用户授权申请被拒绝"),
    因访问对象隐私设置被拦截("A0310", "因访问对象隐私设置被拦截"),
    授权已过期("A0311", "授权已过期"),
    无权限使用("A0312", "无权限使用"), // 去除历史尾部空格，保证实际返回文案与错误码文档一致。
