...
public class MysqlConfig {
    ...
    public DataSource dataSource(@Qualifier("master") DataSource primary, @Qualifier("gray") DataSource gray, @Qualifier("bank") DataSource bank, @Qualifier("hx") DataSource hx, @Qualifier("jghx") DataSource jghx, @Qualifier("hz") DataSource hz) {
        ...
        dataSource.addDataSource("master", new DataSourceProxy(primary));
        dataSource.addDataSource("gray", new DataSourceProxy(gray));
        dataSource.addDataSource("bank", new DataSourceProxy(bank));
        dataSource.addDataSource("hx", new DataSourceProxy(hx));
        dataSource.addDataSource("jghx", new DataSourceProxy(jghx));
        dataSource.addDataSource("hz", new DataSourceProxy(hz));
        return dataSource;
    }
